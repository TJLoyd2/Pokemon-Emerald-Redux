...
enum __attribute__((packed)) Species
{
	...
	// Convergent Species
	SPECIES_FOGGING = 1573,
	SPECIES_BREEZING = 1574,
	SPECIES_STORMING = 1575,
	SPECIES_MERRYKARP = 1576,
	SPECIES_GYAREVELRY = 1577,
	SPECIES_MARBEEP = 1578,
	SPECIES_FLUFFBEE = 1579,
	SPECIES_AMPHYBUZZ = 1580,
	SPECIES_SHRUBMA = 1581,
	SPECIES_ARCHCARGO = 1582,
	SPECIES_ESCARGOLITHE = 1583,
	SPECIES_CORALTS = 1584,
	SPECIES_MARILIA = 1585,
	SPECIES_SIRENVOIR = 1586,
	SPECIES_RIPPLADE = 1587,
	SPECIES_MANUHITA = 1588,
	SPECIES_FURNIYAMA = 1589,
	SPECIES_KILOZUNA = 1590,
	SPECIES_WHIZMUR = 1591,
	SPECIES_VOLTRED = 1592,
	SPECIES_EXHERTZ = 1593,
	SPECIES_BAYRON = 1594,
	SPECIES_TAIRON = 1595,
	SPECIES_CRAGGRON = 1596,
	SPECIES_PRISBLU = 1597,
	SPECIES_IRISARIA = 1598,
	SPECIES_SNOPINCH = 1599,
	SPECIES_FROSTRAVA = 1600,
	SPECIES_FLURROGON = 1601,
	SPECIES_BAUBLEYE = 1602,
	SPECIES_DIGON = 1603,
	SPECIES_BURROGON = 1604,
	SPECIES_TERRAMENCE = 1605,
	SPECIES_BLOCLI = 1606,
	SPECIES_BLOXTACK = 1607,
	SPECIES_GARGABLOX = 1608,
	// New Evolutions
	SPECIES_SKULBERUS = 1609,
	SPECIES_MYCELPION = 1610,
	SPECIES_KAIOSEA = 1611,
	SPECIES_GYARADEATH = 1612,
	SPECIES_TENTAGREWL = 1613,
	SPECIES_DEVOUSTRIC = 1614,
	SPECIES_TORTEMPLE = 1615,
	SPECIES_BOARLOCK = 1616,
	SPECIES_SPINDAZE = 1617,
	SPECIES_CACJACK = 1618,
	SPECIES_CRAWSOLUTE = 1619,
	SPECIES_BRONTONANA = 1620,
	SPECIES_SHYDUCK = 1621,
	SPECIES_SLYDUCK = 1622,
	SPECIES_CARBONIX = 1623,
	SPECIES_BARIONG = 1624,
	SPECIES_ERATICATE = 1625,
	SPECIES_TERROW = 1626,
	SPECIES_ARACHTRES = 1627,
	SPECIES_PHANTOWL = 1628,
	SPECIES_DUELUMBER = 1629,
	SPECIES_MAGMENOUS = 1630,
	SPECIES_ESCARGINITE = 1640,
	
	// Hoennian Forms
	SPECIES_ABRA_HOENN = 1631,
	SPECIES_KADABRA_HOENN = 1632,
	SPECIES_ALAKAZAM_HOENN = 1633,
	SPECIES_MACHOP_HOENN = 1634,
	SPECIES_MACHOKE_HOENN = 1635,
	SPECIES_MACHAMP_HOENN = 1636,
	SPECIES_DODUO_HOENN = 1637,
	SPECIES_DODRIO_HOENN = 1638,
	SPECIES_SKARMORY_HOENN = 1639,
	SPECIES_PSYDUCK_HOENN = 1641,
	SPECIES_GROWLITHE_HOENN = 1642,
	SPECIES_ARCANINE_HOENN = 1643,
	SPECIES_WEEDLE_HOENN = 1644,
	SPECIES_KAKUNA_HOENN = 1645,
	SPECIES_BEEDRILL_HOENN = 1646,
	SPECIES_BELLSPROUT_HOENN = 1647,
	SPECIES_WEEPINBELL_HOENN = 1648,
	SPECIES_VICTREEBEL_HOENN = 1649,
	SPECIES_CLEFFA_HOENN = 1650,
	SPECIES_CLEFAIRY_HOENN = 1651,
	SPECIES_CLEFABLE_HOENN = 1652,
	SPECIES_SEEL_HOENN = 1653,
	SPECIES_DEWGONG_HOENN = 1654,
	SPECIES_EXEGGCUTE_HOENN = 1655,
	SPECIES_EXEGGUTOR_HOENN = 1656,
	SPECIES_SPEAROW_HOENN = 1657,
	SPECIES_FEAROW_HOENN = 1658,
	SPECIES_KRABBY_HOENN = 1659,
	SPECIES_KINGLER_HOENN = 1660,
	SPECIES_MUNCHLAX_HOENN = 1661,
	SPECIES_SNORLAX_HOENN = 1662,
	SPECIES_RATTATA_HOENN = 1663,
	SPECIES_RATICATE_HOENN = 1664,
	SPECIES_SCYTHER_HOENN = 1665,
	SPECIES_SCIZOR_HOENN = 1666,
	SPECIES_KLEAVOR_HOENN = 1667,
	SPECIES_LARVITAR_HOENN = 1668,
	SPECIES_PUPITAR_HOENN = 1669,
	SPECIES_TYRANITAR_HOENN = 1670,
	SPECIES_SWINUB_HOENN = 1671,
	SPECIES_PILOSWINE_HOENN = 1672,
	SPECIES_MAMOSWINE_HOENN = 1673,
	SPECIES_HOUNDOUR_HOENN = 1674,
	SPECIES_HOUNDOOM_HOENN = 1675,
	SPECIES_GLIGAR_HOENN = 1676,
	SPECIES_GLISCOR_HOENN = 1677,
	
	//NEW REGIONAL AND EVOLUTIONS
	SPECIES_PENTAWUG = 1678,
    SPECIES_CUSTOM_END,
